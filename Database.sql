...
SELECT Countries.country_name, COUNT(Athletes.athlete_id) as total_athletes FROM Countries,Athletes where Countries.country_id = Athletes.country_id GROUP BY Countries.country_name;
